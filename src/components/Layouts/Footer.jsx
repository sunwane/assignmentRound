function Footer() {
  return (
    <footer className="bg-(--primary-color) border-t-2 border-(--border-color)">
      <div className="flex justify-between items-start py-8 px-10 gap-8">
        <div className="flex-1 max-w-xs">
          ...
          <div className="text-sm text-gray-400 text-justify">
      ...
      <div className="w-full flex items-center justify-between px-12 py-4 border-t border-(--border-color)">
