        ...
        >
          ...
          <div>
            ...
            <p className="leading-8 text-blue-100">
              Create your account and build your personal bookshelf.
            </p>
        ...
        >
          ...
          <form className="space-y-4">
            ...
            <input
              ...
              className="w-full py-3 border-b-2 bg-transparent outline-none focus:outline-0 focus:border-blue-500 border-(--border-color)"
            />
